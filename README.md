# Vista de Doctores
Este proyecto brinda a los doctores que inician sesión, una documentación muy clara sobre su información y datos calculados. 

# Tecnologías
HTML, CSS, JavaScript y PureCSS.

# Instalación
Para ejecutar este proyecto de forma local, siga los siguientes pasos:


1. Clonar el repositorio: git clone https://github.com/GonzaloTafur/VistaDoctores.git cd VistaDoctores

2. Descomprimr el proyecto.
